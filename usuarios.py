...
def registrar_usuario(nombre_completo, email, contraseña):
    ...
    nuevo_usuario = {'nombre_completo' : nombre_completo, 'email' : email, 'contraseña' : contraseña, 'rol' : 2} #se le asigna rol estandar al registrador.
...
def modificar_rol(email_usuario, nuevo_rol):
    ...
    if nuevo_rol not in roles_validos:
        return False, f'rol no válido. Los roles permitidos son: {roles_validos}'
    for u in usuarios:
